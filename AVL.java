...
public class AVL<E extends Comparable<E>> {
	...
	/**
	 * Returns the balance factor of a node. The balance factor is the difference in 
	 * the height of a node's right child and its left child. 
	 * 
